                ...
                <Form.Field className="flex flex-col gap-2" name="min_price">
                  ...
                  <div className="relative">
                    <Form.Control asChild>
                      <input
                        className="box-border inline-flex h-[40px] w-full appearance-none items-center justify-center rounded border bg-slate-100 pl-8 pr-4 font-sans text-base leading-none text-slate-900 outline-none selection:bg-blue-600 selection:text-white hover:shadow-[0_0_0_1px_black] focus:shadow-[0_0_0_2px_black]"
                        type="number"
                        value={minPrice}
                        // max={maxPrice}
                        placeholder="No min"
